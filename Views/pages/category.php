<table>
    ...
    foreach ($blog->Category($category_id) as $item) {
        ?>
        <td>
        <tr>
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                        <a class="good_link" href="index.php?view=product&id=<? echo $item['id']; ?>">
                ...
                <div class="choose">
                    <ul class="nav nav-pills nav-justified">
                        <li><a href="index.php?view=AddToCompare&id=<?echo $item['id'];?>&cat=<?= $item['category'] ?>"><i class="fa fa-plus-square"></i>Добавить в список сравнения</a></li>
                </ul>
            </div>
        </div>
    </div>
